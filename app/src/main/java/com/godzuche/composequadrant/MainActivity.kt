package com.godzuche.composequadrant
...
import com.godzuche.composequadrant.ui.theme.ComposeQuadrantTheme
...
@Composable
fun ComposableFunctionsInfoCard(
    title: String,
    description: String,
